...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/basket.svg
  SvgGenImage get basket => const SvgGenImage('assets/images/basket.svg');

  /// File path: assets/images/configuration.svg
  SvgGenImage get configuration =>
      const SvgGenImage('assets/images/configuration.svg');

  /// File path: assets/images/container.png
  AssetGenImage get container =>
      const AssetGenImage('assets/images/container.png');

  /// File path: assets/images/stack.svg
  SvgGenImage get stack => const SvgGenImage('assets/images/stack.svg');
  ...
  List<dynamic> get values =>
      [avatar, basket, configuration, container, stack, wallet];
}
